...
export default function PorsantPage() {
    ...
    // Note: MainLayout includes Header which has logout logic. 
    // We might want to keep it for now as per user request to have "our current program in porsant section".
    // The global dashboard sidebar/header handles the main nav, but this inner layout handles the tabs.

    return (
        <div className="h-full flex flex-col">
            {/* We wrap it in a div to ensure it takes height */}
