...
const CollaborationDetailsSchema: Schema = new Schema(
  {
...
export const CollaborationDetails =
  mongoose.models.CollaborationDetails ||
  mongoose.model<ICollaborationDetails>("CollaborationDetails", CollaborationDetailsSchema)
